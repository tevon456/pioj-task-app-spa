 ...
 * @prop {string} cursor - cursor style on hover.
...
const Box = styled.div`
  ...
  padding-top: ${(props) => props.pt || props.py || props.pd};
  padding-bottom: ${(props) => props.pb || props.py || props.pd};
  padding-left: ${(props) => props.pl || props.px || props.pd};
  padding-right: ${(props) => props.pr || props.px || props.pd};
